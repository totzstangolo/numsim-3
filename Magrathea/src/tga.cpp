...
void TGA::FlipImg() { // Flips the image vertically (Why store images upside
                      // down?)
  unsigned char bTemp;
...
int TGA::GetBPP() { return iBPP; }

int TGA::GetWidth() { return iWidth; }

int TGA::GetHeight() { return iHeight; }

unsigned char *TGA::GetImg() { return pImage; }

unsigned char *TGA::GetPalette() { return pPalette; }
